...
const { bookVenue, getBookingsForAdmin, getMyBookings, deleteMyBooking, getFutureBookedDates } = require('../controllers/bookingController');
...
router.get("/venue/:venueId/future-dates", getFutureBookedDates);
